...
echo "   Watch the release workflow: https://github.com/pdomain/pdomain-ocr-trainer-spa/actions"
echo "   Release page (once workflow finishes): https://github.com/pdomain/pdomain-ocr-trainer-spa/releases/tag/$VERSION"
