"""Settings for pdomain-ocr-trainer-spa (env prefix: PD_OCR_TRAINER_SPA_)."""
...
def _default_app_data_root() -> Path:
    ...
    if sys.platform == "darwin":
        return Path.home() / "Library" / "Application Support" / "pdomain-ocr-trainer-spa"
    if sys.platform == "win32":
        base = Path.home() / "AppData" / "Local"
        return base / "pdomain-ocr-trainer-spa"
    return Path.home() / ".local" / "share" / "pdomain-ocr-trainer-spa"
