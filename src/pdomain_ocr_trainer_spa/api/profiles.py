...
from pdomain_ocr_trainer_spa.core.enums import (  # noqa: TC001 — pydantic resolves at model-build time
    TaskEnum,
    TypefaceEnum,
)
from pdomain_ocr_trainer_spa.core.models import Profile  # noqa: TC001 — pydantic resolves at model-build time
...
async def get_training_defaults_seed(
    ...
    """Return the seed (``pdomain-ocr-training`` config-model defaults) for a task (spec 04 §3.2)."""
    _ = name
