...
:class:`~pd_ocr_trainer_spa.core.models.Run`), ``args.json`` (the resolved
...
Run *execution* happens in the worker subprocess supervised by the pd-ocr-ops
...
from pd_ocr_trainer_spa.core.models import Run
from pd_ocr_trainer_spa.domain.profiles import get_profile, normalize_profile_name
