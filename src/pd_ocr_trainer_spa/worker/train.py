...
4. Instantiates ``pd_ocr_training.LocalTrainingRunner`` and **fully drains**
...
if TYPE_CHECKING:
    ...
    from pd_ocr_training.protocols import DetectionConfig, RecognitionConfig
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(prog="pd_ocr_trainer_spa.worker.train")
