...
The worker subprocess is owned by the pd-ocr-ops ``LongJobRunner``; this
...
from pd_ocr_trainer_spa.core.models import Run  # noqa: TC001 — pydantic resolves at model-build time
