# pd-ocr-trainer-spa conventions
...
`docs/decisions/lint-deviations.md`, which records the rule, the tool, the
...
- A suppression whose inline rationale exists but is missing from
  `docs/decisions/lint-deviations.md` — CT decides whether to catalogue it or
